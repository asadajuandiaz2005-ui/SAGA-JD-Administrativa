...
const moduleTokenMap = (() => {
  ...
  const aliases: Record<string, string> = {
    ...
    quejas: "quejasugerenciasreportes",
    queja: "quejasugerenciasreportes",
    sugerencias: "quejasugerenciasreportes",
    sugerencia: "quejasugerenciasreportes",
    reportes: "quejasugerenciasreportes",
    reporte: "quejasugerenciasreportes",
    calidad: "calidadagua",
    agua: "calidadagua",
